          ...
          <div class="col-md-9">
            <div class="card">
              <div class="card-header p-2">
                  <a href="{{ route('kritik.create') }}" class="btn btn-primary btn-sm m-2 float-right">Komentar <i class="fas fa-comment" style="color: #ffffff;"></i> </a>
                  ...
                  <div class="active tab-pane" id="activity">
                    ...
                    <div class="post">
                      <div class="user-block">
                        ...
                        <span class="username">
                          <a href="{{ $kritik->user->id }}">{{ $kritik->user->name }}</a>
                          <a href="#" class="float-right btn-tool"><i class="fas fa-times"></i></a>
                        </span>
                        <span class="description">{{ $kritik->content }}</span>
                      </div>
                      <!-- /.user-block -->
                      <p>
                        {{ $kritik->point }}
