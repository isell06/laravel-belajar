          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">DataTable untuk Cast</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <a href="{{ route('cast.create') }}" class="btn btn-success btn-sm mb-2 float-right"><i class="fas fa-plus"></i> Tambah</a>
                        ...
                        <tr>
                            ...
                            <td>
                              ...
                              @method('DELETE')
                                ...
                                <button type="submit" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#hapusData">
                                  Delete
                                </button>
                              </form>
                            </td>
